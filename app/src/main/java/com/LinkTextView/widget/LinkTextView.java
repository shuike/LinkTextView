package com.LinkTextView.widget;
...
import com.LinkTextView.R;
import com.LinkTextView.listener.LinkTouchMovementMethod;
import com.LinkTextView.listener.Linkify;
import com.LinkTextView.listener.OnSpanClickListener;
...
public class LinkTextView extends TextView implements OnSpanClickListener, ISpanTouchFix {
    ...
    public LinkTextView(Context context, AttributeSet attrs) {
        ...
        mLinkBgColor = array.getColorStateList(R.styleable.LinkTextView_linkBackgroundColor);
        mLinkTextColor = array.getColorStateList(R.styleable.LinkTextView_linkTextColor);
        array.recycle();
        if (mOriginText != null) {
            setText(mOriginText);
        }
